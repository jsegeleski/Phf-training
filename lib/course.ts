...
`,
    questions: [
      {
        question: "Why do endurance athletes consume carbohydrates during exercise?",
        options: [
          "To improve flexibility",
          "To replace energy being used during exercise",
      ...
      {
        question: "Roughly when do glycogen stores begin to become a limiting factor during hard exercise?",
        options: ["10 minutes", "30 minutes", "90-120 minutes", "8 hours"],
        answer: "90-120 minutes",
      },
      {
        question: "According to PF&H, what matters more initially?",
        options: [
          "Product flavour",
          "Brand name",
      ...
      {
        question: "Current evidence still supports carbohydrate as the primary fuel source for high-intensity endurance performance.",
        options: ["True", "False"],
        answer: "True",
      },
    ],
...
`,
    questions: [
      {
        question: "What carb intake is generally recommended for exercise lasting 1-2 hours?",
        options: ["10-20g/hr", "30-60g/hr", "90-120g/hr", "None"],
        answer: "30-60g/hr",
      },
      {
        question: "What carb intake is generally recommended for exercise lasting longer than 2 hours?",
        options: ["20-30g/hr", "40-50g/hr", "60-90g/hr", "200g/hr"],
        answer: "60-90g/hr",
      },
      {
        question: "Many athletes consume less carbohydrate than would likely benefit their performance.",
        options: ["True", "False"],
        answer: "True",
      },
      {
        question: "What is gut training?",
        options: [
          "Strengthening abdominal muscles",
          "Practicing higher carbohydrate intake during training",
          "Eating more fibre",
          "Drinking more water",
        ],
        answer: "Practicing higher carbohydrate intake during training",
      },
      {
        question: "Can elite athletes consume more than 120g/hour of carbohydrate?",
        options: [
          "No",
          "Only in training",
          "Yes, some do, but it requires significant gut training",
          "Only cyclists",
        ],
        answer: "Yes, some do, but it requires significant gut training",
      },
    ],
  },
  {
...
`,
    questions: [
      {
        question: "What is the primary electrolyte lost in sweat?",
        options: ["Protein", "Sodium", "Fibre", "Vitamin C"],
        answer: "Sodium",
      },
      {
        question: "What does sodium help regulate?",
        options: [
          "Fluid balance",
          "Muscle function",
          "Nutrient absorption",
      ...
      {
        question: "Hydration and fueling are exactly the same thing.",
        options: ["True", "False"],
        answer: "False",
      },
      {
        question: "Why is drinking only water sometimes insufficient during long events?",
        options: [
          "Water contains too many calories",
          "Athletes also lose sodium through sweat",
          "Water is difficult to absorb",
          "Water causes cramps",
        ],
        answer: "Athletes also lose sodium through sweat",
      },
      {
        question: "Do all athletes lose the same amount of sodium in sweat?",
        options: ["Yes", "No"],
        answer: "No",
      },
    ],
...
Many traditional sports drinks attempt to provide carbohydrates, fluid, and electrolytes all in one product.

PF&H often allows athletes to manage carbohydrate intake and sodium intake independently, creating greater flexibility.

For example, on a hot day an athlete might need more fluid and sodium but not necessarily more carbohydrates.

Separating fuel from hydration makes it easier to adjust each variable independently.

This flexibility is one of the major reasons endurance athletes have increasingly adopted the PF&H approach.
`,
    questions: [
      {
        question: "How many grams of carbohydrate are in a PF 90 Gel?",
        options: ["30g", "60g", "90g", "120g"],
        answer: "90g",
      },
      {
        question: "How many grams of carbohydrate are in a PF 30 Chew serving?",
        options: ["15g", "20g", "30g", "60g"],
        answer: "30g",
      },
      {
        question: "How much sodium is contained in one electrolyte capsule?",
        options: ["100mg", "250mg", "500mg", "1000mg"],
        answer: "250mg",
      },
      {
        question: "Which hydration product contains the highest sodium concentration?",
        options: ["PH 500", "PH 1000", "PH 1500", "PF 90 Gel"],
        answer: "PH 1500",
      },
      {
        question: "Why does PF&H often separate carbohydrates and electrolytes?",
        options: [
          "Lower manufacturing costs",
          "To give athletes greater flexibility",
          "To make products larger",
          "To reduce carb absorption",
        ],
        answer: "To give athletes greater flexibility",
      },
    ],
  },
  {
...
Some athletes sweat heavily while others barely sweat at all. Some lose very large amounts of sodium, while others lose relatively little. Some can comfortably consume large amounts of carbohydrate, while others need time and practice to build up their tolerance.
...
One of the strengths of Precision Fuel & Hydration products is their relatively simple ingredient philosophy.

The products focus on delivering carbohydrates, fluids, and electrolytes without unnecessary extras.
...
`,
    questions: [
      {
        question: "A customer is doing a 5-hour ride. Which statement is most accurate?",
        options: [
          "Water is all they need",
          "Carbohydrates and hydration should both be considered",
          "Only electrolytes matter",
          "Only gels matter",
        ],
        answer: "Carbohydrates and hydration should both be considered",
      },
      {
        question: "What is the primary fuel source for hard endurance exercise?",
        options: ["Protein", "Fat", "Carbohydrate", "Sodium"],
        answer: "Carbohydrate",
      },
      {
        question: "A customer prefers plain water during exercise. Which PF&H product may help them replace sodium?",
        options: [
          "PF 90 Gel",
          "PF 30 Chews",
          "Electrolyte Capsules",
        ...
        answer: "Electrolyte Capsules",
      },
      {
        question: "All athletes should consume exactly the same amount of sodium and carbohydrate.",
        options: ["True", "False"],
        answer: "False",
      },
      {
        question: "Which statement best reflects the Precision Fuel & Hydration philosophy?",
        options: [
          "Everyone should use the same product.",
          "Product formulation is always more important than carb intake.",
          "Understand carbohydrate needs first, then choose the best fueling format.",
          "Hydration does not matter if fueling is correct.",
        ],
        answer: "Understand carbohydrate needs first, then choose the best fueling format.",
      },
    ],
  },
];